...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            string fullPath = Path.GetFullPath(textBox1.Text).TrimEnd(Path.DirectorySeparatorChar);
            string ProgramName = Path.GetFileName(fullPath);
            string pathadd = @"E:\1. work\apprentice\Exam-Copy\PEASmartQ\PEASmartQ\addfile\Copy" + ProgramName +".bat";
            File.Create(pathadd).Dispose();

            using (TextWriter create = new StreamWriter(pathadd))
            {
                create.WriteLine("@echo off");
                create.WriteLine("xcopy "+textBox1.Text+"   "+"\""+ "E:\\1. work\\apprentice\\Exam-Copy\\PEASmartQ\\PEASmartQ\\Program\\" + ProgramName +"\""+ "  /s /y /e /i ");
                create.WriteLine("");
                create.WriteLine("xcopy "+textBox1.Text+"\\*.exe*   "+"\""+ "E:\\1. work\\apprentice\\Exam-Copy\\PEASmartQ\\PEASmartQ\\Program\\Shortcut" + "\"" + "  /s /y /e /i ");
                create.WriteLine("");
                create.WriteLine("call " + "\""+"E:\\1. work\\apprentice\\Exam-Copy\\PEASmartQ\\PEASmartQ\\Deladdfile.bat\"");
                create.WriteLine("");

            }
            Process.Start("E:\\1. work\\apprentice\\Exam-Copy\\PEASmartQ\\PEASmartQ\\addfile\\Copy" + ProgramName + ".bat");
